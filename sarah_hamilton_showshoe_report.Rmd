...
The mean weight for male juvenile hares (`r hares_summary$mean_weight2[2]`) is `r dif_means` g greater than that for female juvenile hares (`r hares_summary$mean_weight2[2]`). The effect size for the means is small (Cohen's d = `r round(weight_cohen$estimate,2)`) and the difference in means is significant (two-sample t-test, t = `r round(weight_t$statistic,2)`, p = `r round(weight_t$p.value,3)`).
