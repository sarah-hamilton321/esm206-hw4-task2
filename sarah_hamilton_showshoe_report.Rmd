...
ggplot(data = hares_updated_grid,aes(x = grid_new, y = weight)) + #create a beeswarm plot
  ...
  labs(x = "Site", 
       ...
       color = "Sex",
       caption = "Figure 2. Juvenile Hare Weight by Site. The site at which the observations were collected \n is plotted on the x axis, with the weight in grams plotted on the y axis. \n The colors indicate the sex of the trapped hare, with red indicating a female hare, blue \n indicating a male hare, and gray indicating that the sex of the hare was not recorded.") + #add labels and caption
  theme(plot.caption = element_text(hjust=0.5)) #center the caption
```
...
- A regression model for weight versus hind foot length indicated that about 30% of the variance in weight is predictable from hind foot length. 
